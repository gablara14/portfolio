...
export const HomeCards: CardProps[] = [
  {
    title: "Curriculo",
    description:
      "Experiências profissionais, cursos, certificados e muito mais",
    link: "/cv",
  },
  {
    title: "Github",
...
export const RewardsCards: CardProps[] = [
  {
    ...
    description:
      "Viagem aos Estados Unidos com base no cumprimento de metas da empresa, 2018",
  },
  {
    title: "Viagem à Bahamas",
    description:
      "Viagem ao Atlantis Paradise Island Resort Bahamas com base no cumprimento de metas da empresa, 2019",
  },
];
...
export const CourseCards: CardProps[] = [
  ...
  },
  {
    ...
    href:
      "https://www.udemy.com/courses/search/?src=ukw&q=Understanding+TypeScript+2021+Edition",
  },
  {
...
export const CertificatesCards: CardProps[] = [
  {
    title: "CPA-20 - ANBIMA",
    date: "Emitido em jan. de 2021 - Expira em jan. de 2024",
    description:
      "O certificado CPA-20 é destinado aos profissionais que atuam na distribuição de produtos de investimento para clientes dos segmentos varejo alta renda, private, corporate e investidores institucionais em agências bancárias ou em plataformas de atendimento.",
...
export const ExperienceCards: CardProps[] = [
  {
    ...
    description:
      "Fundou e administrou uma empresa que gerou mais de R$1.5 milhões de faturamento em poucos meses.",
...
export const GLACards: CardProps[] = [
  ...
  },
  {
    ...
    description:
      "Facebook e Instagram ads, Google e Youtube ads, Taboola etc..",
  },
  {
...
export const JNSCARDS: CardProps[] = [
  {
    title: "",
    description:
      "Essa experiência foi fundamental no desenvolvimento das seguintes habilidades: venda, liderança e oratória.",
  },
];
